...
--
-- Current Database: `traafix`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `traafix` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
CREATE TABLE `tf1_options` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `tf1_unique_options` (`name`,`groupid`),
...
INSERT INTO `tf1_options` VALUES (2,'blue',1),(3,'green',1),(6,'L',2),(5,'M',2),(1,'red',1),(4,'S',2),(7,'XL',2),(8,'XXL',2);
...
INSERT INTO `tf1_productcategories` VALUES (1,'Running'),(2,'Walking'),(3,'HIking'),(4,'Track and Trail'),(5,'Short Sleave'),(6,'Long Sleave'),(7,'Running'),(8,'Walking'),(9,'HIking'),(10,'Track and Trail'),(11,'Short Sleave'),(12,'Long Sleave'),(13,'test cat'),(14,'updated'),(15,'semma tee 15'),(16,'semma tee 16'),(17,'semma tee 161'),(18,'semma tee 161'),(19,'asd'),(20,'sadasdsa'),(21,'semma tee 21'),(22,'22 updated');
...
INSERT INTO `tf1_products` VALUES (1,'000-0001','Cotton T-Shirt',9.99,3.00,'Light Cotton T-Shirt','A light cotton T-Shirt made with 100% real cotton.','A light cotton T-Shirt made with 100% real cotton.\r\n\r\nMade right here in the USA for over 15 years, this t-shirt is lightweight and durable.','','',5,'2013-06-12 19:30:50',100,1,0,NULL),(2,'000-0004','Los Angeles',179.99,8.00,'Track and Trail','A rugged track and trail athletic shoe','A rugged track and trail athletic shoe','','',4,'2013-07-25 13:34:36',NULL,0,1,NULL),(3,'000-0001','Cotton T-Shirt',9.99,3.00,'Light Cotton T-Shirt','A light cotton T-Shirt made with 100% real cotton.','A light cotton T-Shirt made with 100% real cotton.\r\n\r\nMade right here in the USA for over 15 years, this t-shirt is lightweight and durable.','','',5,'2013-06-12 19:30:50',100,1,0,NULL),(4,'000-0004','Los Angeles',179.99,8.00,'Track and Trail','A rugged track and trail athletic shoe','A rugged track and trail athletic shoe','','',4,'2013-07-25 13:34:36',NULL,0,1,NULL),(5,'000-0005','my tee',379.00,800.00,'tee in cart','this is short desc','this is long dis','','',4,'2013-07-25 13:34:36',100,0,1,'chennai');
...
-- Dump completed on 2016-11-23 22:42:45
